...
GridCsvMixin, mixed into LayerManager, containing PointGeo_grid.csv
generation/deployment and in-memory loading (including building the
ref_points Delimited Text layer).
"""
